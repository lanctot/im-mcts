...
\chessboard
\end{center}
\caption{An example position in Breakthrough.}
\end{figure}

\subsection{Kalah}

Kalah is a turn-based game in the Mancala family of games. Each player has six houses, each 
...
Kalah has been weakly solved for several different starting configurations~\cite{Irving00Solving}, 
