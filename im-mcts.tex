...
the initial experiment, all under 1 second of search time.
...
efLH       & MCTS(im$0.4$)     & $\alpha\beta$    &  130   & 120     & 59.23      \\     
\hline
\end{tabular}
\end{center}
...
upon which MC-LOA is based, winning the previous 4 Olympiads. Both use state-of-the-art techniques, including highly-optimized alpha-beta 
playouts. MIA includes the following enhancements: static
