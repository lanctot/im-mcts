...
We first determined the best playout strategy amongst fixed and dynamic early terminations  
and $\epsilon$-greedy playouts. Through systematic testing on thousands of games, we determined that 
the best playout policy when using the simple evaluation function is the combination (ege$0.1$,det$0.5$). 
This was suprising since fixed early terminations are much faster, however is likely explained by less 
