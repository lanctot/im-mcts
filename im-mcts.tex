...
play performance in four games: Lines of Action, Chinese Checkers, Breakthrough, and/or \{Mancala,Hearts\}.
\end{abstract}
...
\mlnote{We'll need to modify how this paragraph to not give away our identities.}
...
\caption{Results in MC-LOA. Each data represents 1000 games with 1 second of search time.} 
\label{fig:loa-alpha}
\end{center}
\end{figure}
...
\item For Chinese Checkers we should also try Progressive History~\cite{Nijssen10Enhancements,Nijssen13PhdThesis} since it was 
      shown to work quite well there.
