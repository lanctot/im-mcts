...
reasons. 
First, in our experience it seems that traps are effectively handled by enabling improving the playout policy. 
...
handled effectively without any additional knowledge, especially when MCTS-Solver is enabled, which is simple and requires no additional 
knowledge. Therefore, we believe that the explanation for the advantage offered by implicit minimax backups is somewhat more subtle
