...
Table~\ref{tbl:kalah-toptourney} shows the results of the top playout winners.
...
Table~\ref{tbl:bt-efMS-toptourney} shows the results of the top playout winners.
...
\end{tabular}
\end{center}
\caption{Breakthrough playout comparisons. \label{tbl:bt-efMS-toptourney}}
\end{table}
...
Table~\ref{tbl:bt-efLH-toptourney} shows the results of the top playout winners.
...
\end{tabular}
\end{center}
\caption{Breakthrough playout comparisons. \label{tbl:bt-efLH-toptourney}}
\end{table}
