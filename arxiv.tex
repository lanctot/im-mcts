...
%% NOTE: extra semicolons neede on some lines to make arXiv compiler show it properly and 
%%       not mess with the line numbers!!
...
\begin{figure}[t!]
\begin{center}
\includegraphics[scale=0.68]{kalah-alpha.pdf}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[scale=0.7]{bt-base-alpha.pdf}\\
\includegraphics[scale=0.7]{bt-basenp-alpha.pdf}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[scale=0.68]{bt-alt-alpha.pdf}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[scale=0.7]{loa-alpha.pdf}
