...
builds ``fortress'' structures \cite{Guid12Fortress} that are handled better than standard MCTS.  
...
Upper and lower bounds could be maintaing for $\alpha\beta$ pruning.
